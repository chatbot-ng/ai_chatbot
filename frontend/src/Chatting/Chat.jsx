...
import { sendMessageAction ,getMessageAction} from "../Redux/action.js"
    ...
    return <>
        ...
        <div className="fixed bottom-5 w-[calc(100vw-3rem)]">
            <div className="flex justify-center sm:px-40 ">
                <input type="text" value={chatbox} name='chatbox' onChange={changeChatBox} onKeyUp={(e)=>e.key==='Enter'&&sendMessage()} placeholder="Ask me a question!" className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md p-2 flex-grow" />
